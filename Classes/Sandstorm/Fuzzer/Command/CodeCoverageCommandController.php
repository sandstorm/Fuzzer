...
class CodeCoverageCommandController extends \TYPO3\Flow\Cli\CommandController {
	...
	/**
	 * Initialize the PHP Code Coverage autoloader
	 */
	public function initializeObject() {
		set_include_path($this->packageManager->getPackage('phpunit.phptokenstream')->getPackagePath() . PATH_SEPARATOR . get_include_path());
		set_include_path($this->packageManager->getPackage('phpunit.phpfileiterator')->getPackagePath() . PATH_SEPARATOR . get_include_path());
		set_include_path($this->packageManager->getPackage('phpunit.phptexttemplate')->getPackagePath() . PATH_SEPARATOR . get_include_path());
		include($this->packageManager->getPackage('phpunit.phpcodecoverage')->getPackagePath() . '/PHP/CodeCoverage/Autoload.php');
	}
